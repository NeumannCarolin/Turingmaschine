...
class VisualTM:
    ...
    def get_grunddokument(self,frames):
        ...
        \subtitle{TU-Berlin, SoSe17, Programmierprojekt} \n \
        \\author{Carolin Neumann\\\} \n \
        \\begin{document} \n \
        \\maketitle \n'                 #Frame mit Anfangsband
        dokument=dokument+'\\begin{frame}[fragile]{Turingmaschine} \n \
        \n \
        \\begin{itemize} \n \
    ...
    def get_tmtikz(self,band):
        ...
        """
        tmframe='\\begin{frame}[fragile]{Turingmaschine} \n \
        \n \
        \\begin{itemize} \n \
        \item Eingabealphabet : '
